...
namespace sanisKafe.DL
{
    public static class DataLayer
    {
        ...
        internal static int SatisEkle(SatisTest s)
        {
            try
            {
                if (conn.State != System.Data.ConnectionState.Open)
                ...
                MySqlCommand komut = new MySqlCommand("abc_SatisEkleTest", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int SatisGüncelle(SatisTest s)
        {
            try
            {
                if (conn.State != System.Data.ConnectionState.Open)
